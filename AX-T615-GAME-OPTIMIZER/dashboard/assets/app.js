...
(() => {
  ...
  function render(raw) {
    ...
    text("recommendationReason", d.reason, "No safe telemetry snapshot has been loaded. Axmanager will not infer device values.");
