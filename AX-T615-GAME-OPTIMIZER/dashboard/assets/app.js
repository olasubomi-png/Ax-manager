...
(() => {
  ...
  const empty = () => ({
    schema: "1", read_only: true, source: "no-snapshot", evidence: {}, decision: {}, orchestrator: {}, session: {}, profiles: [], plugins: {}, plugin_health: {}, evidence_engine: {}, analysis: {}, policy: {}, safety: {}, version: UNKNOWN
  });
