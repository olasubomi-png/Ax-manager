...
(() => {
  ...
  function render(raw) {
    ...
    text("frameTimeValue", display(e.frame_time_ms, " ms"), "UNKNOWN"); text("pacingValue", label(e.frame_pacing, "UNKNOWN"), "UNKNOWN"); text("powerValue", display(e.estimated_watts, " W"), "UNKNOWN"); text("timelineDescription", Array.isArray(raw.history) && raw.history.length ? "Bounded-session samples supplied by the exported snapshot." : "No bounded-session history was included in this snapshot.");
